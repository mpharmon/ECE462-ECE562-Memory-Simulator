...
public class BabyCacheTestNextLine{
	
	protected static CacheController L2;
	
	protected static NextlinePrefetcherCacheController L1;
	...
	public static void TestAccess() throws Exception{
		System.out.println("\n+------------------------------+");
		System.out.println("| Running Test Memory Access |");
		System.out.println("+------------------------------+\n");
		
		//L1.get(true, 0);
		for(int i = 31; i < 8192; i+=32){
			L1.get(true, i);
		}
